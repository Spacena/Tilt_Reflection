...
Container {
    ...
    Container {
        ...
        ColoredBlock {
            ...
            verticalAlignment: VerticalAlignment.Center
            opacity: (tiltAngle > 15 || (tiltAngle > 0 && tiltAngle < 8)) ? 1 : 0
        }
        ColoredBlock {
            ...
            verticalAlignment: VerticalAlignment.Center
            opacity: (tiltAngle > 23 || (tiltAngle > 0 && tiltAngle < 8)) ? 1 : 0
        }
        ColoredBlock {
            ...
            verticalAlignment: VerticalAlignment.Center
            opacity: (tiltAngle > 29 || (tiltAngle > 0 && tiltAngle < 8)) ? 1 : 0
        }           
        ColoredBlock {
            ...
            verticalAlignment: VerticalAlignment.Center
            opacity: (tiltAngle > 35 || (tiltAngle > 0 && tiltAngle < 8)) ? 1 : 0
        }            
        ColoredBlock {
            ...
            verticalAlignment: VerticalAlignment.Center
            opacity: (tiltAngle > 41 || (tiltAngle > 0 && tiltAngle < 8)) ? 1 : 0
        }        
    }
}
