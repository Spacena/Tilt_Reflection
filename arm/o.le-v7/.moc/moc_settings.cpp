...
static const char qt_meta_stringdata_Settings[] = {
    "Settings\0\0tiltChanged()\0onManualExit()\0"
    "int\0tilt\0"
};
...
void Settings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->tiltChanged(); break;
        case 1: _t->onManualExit(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
int Settings::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< int*>(_v) = tilt(); break;
        }
        _id -= 1;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setTilt(*reinterpret_cast< int*>(_v)); break;
        }
        _id -= 1;
