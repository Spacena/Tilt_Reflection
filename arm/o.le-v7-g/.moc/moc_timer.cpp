...
static const char qt_meta_stringdata_Timer[] = {
    ...
    "activeChanged()\0start()\0stop()\0int\0"
    "curTimeHour()\0curTimeMinute()\0"
    "curTimeSecond()\0bool\0active\0interval\0"
};
...
void Timer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: { int _r = _t->curTimeHour();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 6: { int _r = _t->curTimeMinute();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 7: { int _r = _t->curTimeSecond();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        default: ;
        }
    }
